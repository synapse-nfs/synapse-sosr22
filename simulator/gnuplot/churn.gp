...
plot "./data/churn-min-resources.tsv" using 2:xtic(1) lt 7 t "Min resources", \
	 "./data/churn-min-cpu-load.tsv" using 2:xtic(1) lt 4 t "Min CPU load", \
	 "./data/churn-max-throughput.tsv" using 2:xtic(1) lt 1 t "Max throughput"